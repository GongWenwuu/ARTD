...
%
% See also psnr_index, ssim_index, StructureSIM, FeatureSIM, ErrRelGlobAdimSyn and SpectAngMapper
% by Yi Peng 'Kronecker-Basis-Representation Based Tensor Sparsity and Its Applications to Tensor Recovery'
% update by Wenwu Gong 04/2023
%==========================================================================
maxP = max(imagery1(:));
[m, n, k] = size(imagery1);
...
fsim = 0;
for i = 1:k
    psnr = psnr + psnr_index(imagery1(:, :, i), imagery2(:, :, i), maxP);
